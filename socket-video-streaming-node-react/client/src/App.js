  ...
  let landingHTML=<>
    ...
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            ...
            <div>
                <div className="actionText">My UserID is -  <span className={copied?"username highlight copied":"username highlight"} onClick={()=>{showCopiedMessage()}}>{yourID}</span>?</div>
            </div>
            ...
            <div>
                To call your friend, ask them to Free Video call tool in their browser. <br/>
